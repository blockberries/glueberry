...
### Changed
- Updated Cramberry dependency to v1.5.3

## [1.2.8] - 2026-01-28

### Changed
- Updated Cramberry dependency to v1.5.2

## [1.2.7] - 2026-01-28

### Changed
- Updated Cramberry dependency to v1.5.1

## [1.2.6] - 2026-01-28

### Changed
- Updated Cramberry dependency to v1.5.0
...
### Changed
- Updated Cramberry dependency to v1.4.3

## [1.2.3] - 2026-01-27

### Fixed
- **Critical**: Fixed double-close race in subscription channels that could cause panic during concurrent unsubscribe and node shutdown
- **Medium**: Fixed encrypted stream close during write race by using RWMutex to protect cipher operations
- **Medium**: Oversized message buffers are now securely zeroed before being dropped

### Added
- `TestChaos_SubscriptionDoubleClose` test to verify subscription race fix

## [1.2.2] - 2026-01-27

### Changed
- Updated Cramberry dependency to v1.4.2
...
|-------------------|------------------|-------------------|------------|
| 1.2.9             | 1.2.9            | 1.5.3             | 1.21+      |
| 1.2.8             | 1.2.8            | 1.5.2             | 1.21+      |
| 1.2.7             | 1.2.7            | 1.5.1             | 1.21+      |
| 1.2.6             | 1.2.6            | 1.5.0             | 1.21+      |
